...
<html lang="de">
  <head>
    ...
    <title>Impressum & Datenschutz - Journaful</title>
    <link
  ...
  <body>
    ...
    <div class="container py-5">
      <section id="impressum">
        <h1>Impressum</h1>
        <p>
          Luis Yannik Roder<br />
          Burchter Straße 19<br />
          65510 Idstein
        </p>

        <h2>Kontakt</h2>
        <p>
          Telefon: +49 157 56196423<br />
          E-Mail: inbox@lusino.de
        </p>
      </section>

      <section id="datenschutz" class="mt-5">
        ...
        <p>
          ...
          gespeichert, die &auml;hnlich wie Cookies personenbezogene Daten
          beinhalten und zur Wiedererkennung eingesetzt werden k&ouml;nnen.
          Details zum erweiterten Datenschutzmodus finden Sie hier:
          <a
            href="https://support.google.com/youtube/answer/171780"
            target="_blank"
            rel="noopener noreferrer"
            >https://support.google.com/youtube/answer/171780</a
          >.
        </p>
        <p>
